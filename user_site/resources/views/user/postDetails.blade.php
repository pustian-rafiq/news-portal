        ...
        <div class="media-left">
            <a href="#">
                <img alt="64x64" class="media-object" data-src="assets/img/reader_img1.jpg"
                     src="{{ asset('user/assets/img/reader_img1.jpg') }}" data-holder-rendered="true">
            </a>
        </div>
        <div class="media-body">
                ...
                <div class="media-left">
                    <a href="#">
                        <img alt="64x64" class="media-object" data-src="assets/img/reader_img2.jpg"
                             src="{{ asset('user/assets/img/reader_img2.jpg') }}" data-holder-rendered="true">
                    </a>
                </div>
                <div class="media-body">
        ...
        <div class="media-left">
            <a href="#">
                <img alt="64x64" class="media-object" data-src="assets/img/reader_img3.jpg"
                     src="{{ asset('user/assets/img/reader_img3.jpg') }}" data-holder-rendered="true">
            </a>
        </div>
        <div class="media-body">
...
<div class="widget hidden-xs m30">
    ...
    <img class="img-responsive adv_img" src="{{ asset('user/assets/img/right_add3.jp') }}g" alt="add_one">
...
<div class="widget m30">
    ...
    <div class="widget_body"><img class="img-responsive left" src="{{ asset('user/assets/img/editor.jpg') }}" alt="Generic placeholder image">
...
<div class="widget m30">
    ...
    <div class="widget_body"><img class="img-responsive left" src="{{ asset('user/assets/img/reader.jpg') }}" alt="Generic placeholder image">
